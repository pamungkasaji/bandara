              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Silahkan Scan Kode QR dengan Aplikasi pada Smartphone Anda</h1>
                    <h5 class="h5 text-gray-900 mb-4">Kunjungi link Kode QR melalui browser anda </h5>
                  </div>
                  <hr>
                </div>
              </div>
