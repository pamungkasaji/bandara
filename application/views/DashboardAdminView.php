      ...
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-s font-weight-bold text-primary mb-1">Jumlah <br> Karyawan</div>
    ...
    <div class="col-xl-2 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-s font-weight-bold text-primary mb-1">Jumlah <br> Area</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_area?></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-2 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-s font-weight-bold text-primary mb-1">Jumlah <br> Subarea</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_subarea?></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-2 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-s font-weight-bold text-primary mb-1">Jumlah <br> Kode QR</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_kodeqr?></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-2 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-s font-weight-bold text-primary mb-1">Jumlah <br> Material</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_material?></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-2 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-s font-weight-bold text-primary mb-1">Jumlah <br> Standard</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_standard?></div>
            </div>
          </div>
        </div>
      </div>
